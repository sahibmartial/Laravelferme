...
*/
    ...
    public function downloadRecapDetailCampagne($data)
    {
        ...
        $apportPersonnel=null;
         $arrayCampagne=[];
        $results = array('Campagne'=>null, 'Apports'=>null, 'Poussin' =>null, 'Perte'=>null,
              'Frais'=>null,'Aliment'=>null,'Accessoire'=>null,'Vente'=>null );
        ...
        if (!empty($arrayPoussin)) {
            $results = array('Campagne'=>array('Budget' => $campagne[0]['budget'],'Obs'=>$campagne[0]['obs']),
                       'Apports'=>array('AppVente'=>$apportVente,'AppPerso'=>$apportPersonnel),
                       'Poussin' =>$arrayPoussin,'Perte'=>null,'Frais'=>null,'Aliment'=>null,
                       'Accessoire'=>null,'Vente'=>null );
        }
        ...
        if (!empty($arrayPerte)) {
            $results = array('Campagne'=>array('Budget' => $campagne[0]['budget'],'Obs'=>$campagne[0]['obs']),'Apports'=>array('AppVente'=>$apportVente,
            'AppPerso'=>$apportPersonnel),'Poussin' =>$arrayPoussin,'Perte'=>$arrayPerte,'Frais'=>null,
            'Aliment'=>null,'Accessoire'=>null,'Vente'=>null );
        }
        ...
        if (!empty($arrayFrais)) {
            $results = array('Campagne'=>array('Budget' => $campagne[0]['budget'],'Obs'=>$campagne[0]['obs']),
            'Apports'=>array('AppVente'=>$apportVente,'AppPerso'=>$apportPersonnel),
            'Poussin' =>$arrayPoussin,'Perte'=>$arrayPerte,'Frais'=>$arrayFrais,'Aliment'=>null,
            'Accessoire'=>null,'Vente'=>null );
        }
        ...
        if (!empty($arrayAliment)) {
            $results = array('Campagne'=>array('Budget' => $campagne[0]['budget'],'Obs'=>$campagne[0]['obs']),
            'Apports'=>array('AppVente'=>$apportVente,'AppPerso'=>$apportPersonnel),
            'Poussin' =>$arrayPoussin,'Perte'=>$arrayPerte,'Frais'=>$arrayFrais,'Aliment'=>$arrayAliment,
            'Accessoire'=>null,'Vente'=>null );
        }
        ...
        if (!empty($arrayAccessoire)) {
            ...
            'Apports'=>array('AppVente'=>$apportVente,'AppPerso'=>$apportPersonnel),
            'Poussin' =>$arrayPoussin,'Perte'=>$arrayPerte,'Frais'=>$arrayFrais,'Aliment'=>$arrayAliment,
            'Accessoire'=>$arrayAccessoire,'Vente'=>null );
        }
        ...
        if (!empty($arrayVente)) {
            ...
            'Apports'=>array('AppVente'=>$apportVente,'AppPerso'=>$apportPersonnel),
            'Poussin' =>$arrayPoussin,'Perte'=>$arrayPerte,'Frais'=>$arrayFrais,'Aliment'=>$arrayAliment,
            'Accessoire'=>$arrayAccessoire,'Vente'=>$arrayVente );
        }
